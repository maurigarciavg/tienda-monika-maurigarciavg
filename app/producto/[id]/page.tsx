...
export default async function ProductoPage({
  ...
  const cuerpo = encodeURIComponent(
    `Hola Monika! Me interesa el producto "${producto.nombre}" (${producto.precio}€). ¿Está disponible?`
  );
    ...
    <div className="min-h-screen py-16 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-4">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="font-display text-4xl text-monnama-brown mb-4">
            {producto.nombre}
          </h1>
          ...
          {producto.disponible ? (
            ...
            <div className="rounded-xl bg-monnama-surface border border-monnama-peach p-6 text-center">
              <p className="text-monnama-brown font-medium text-lg mb-1">Actualmente agotado</p>
